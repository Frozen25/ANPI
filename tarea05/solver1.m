function ans = solver1()
  ...
  f = @function1; %This is to pass the function1 as a parameter
  
  [x3,y3] = RungeKutta_4(f,0,1,1,factors(1));
  [x4,y4] = RungeKutta_4(f,0,1,1,factors(2));
  [x5,y5] = RungeKutta_4(f,0,1,1,factors(3));
  [x6,y6] = RungeKutta_4(f,0,1,1,factors(4));
  [x7,y7] = RungeKutta_4(f,0,1,1,factors(5));
  [x8,y8] = RungeKutta_4(f,0,1,1,factors(6));
  [x9,y9] = RungeKutta_4(f,0,1,1,factors(7));
  [x10,y10] = RungeKutta_4(f,0,1,1,factors(8));
