...
//Original method taken from Numerical Recipes: The art of scientific computing, third edition.
    template <class T>
    void poldiv(bmt::polynomial<T> &u, bmt::polynomial<T> &v,
        bmt::polynomial<T> &q, bmt::polynomial<T> &r) {
        ...
        q[u.degree()] = T(0); // May do a resize.
